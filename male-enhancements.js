...
function brandHeader(){var top=document.querySelector('header .top');if(!top||top.dataset.branded)return;top.dataset.branded='1';top.innerHTML=logoHtml()+'<div class="app-id"><b>Treino Tracker</b><br>V1.02</div>';}
